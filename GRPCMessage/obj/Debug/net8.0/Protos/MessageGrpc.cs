...
namespace GRPCMessage {
  public static partial class WeatherT
  {
    ...
    /// <summary>Base class for server-side implementations of WeatherT</summary>
    [grpc::BindServiceMethod(typeof(WeatherT), "BindService")]
    public abstract partial class WeatherTBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::GRPCMessage.WeatherState> GetWeather(global::GRPCMessage.WeatherCity request, grpc::ServerCallContext context)
      {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(WeatherTBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, WeatherTBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_GetWeather, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GRPCMessage.WeatherCity, global::GRPCMessage.WeatherState>(serviceImpl.GetWeather));
    }
